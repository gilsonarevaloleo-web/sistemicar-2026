          ...
          <div className="space-y-3">
            <div>
              <div className="flex items-center justify-between gap-2 mb-1">
                ...
                <button
                  type="button"
                  onClick={() => copyVendedorLink(demoCode)}
              ...
              <p className="text-[10px] font-mono text-slate-600 break-all">
                {buildSellerVendedorUrl(demoCode || "TU-CODIGO")}
              </p>
            </div>
            <div>
              <div className="flex items-center justify-between gap-2 mb-1">
                <p className="text-[10px] uppercase tracking-wider text-slate-500">Checkout directo</p>
                <button
                  type="button"
                  onClick={() => copyLink(demoCode)}
                  className="px-3 py-1.5 rounded-lg font-bold text-[10px] flex items-center gap-1 border border-white/15 text-slate-300"
                  data-testid="button-copy-pagos-link"
                >
                  <Copy size={12} />
                  Copiar
                </button>
